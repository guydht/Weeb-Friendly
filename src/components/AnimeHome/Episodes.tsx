...
import changableTextStyles from "../../classes/css/ChangableText.module.css";
...
import TorrentUtils, { SearchResult, Sources, sourcesPriority } from "../../classes/TorrentUtils";
import { groupBy } from "../../classes/utils";
...
export class DisplayEpisodes extends Component<AnimePageProps & { episodes: SearchResult[] }> {
...
export default class Episodes extends Component<AnimePageProps & { episodes: SearchResult[], loading: boolean, chosenForDownload: number[] }> {
    state: {
        anime: AnimeEntry,
        info: AnimeById,
