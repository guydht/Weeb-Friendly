...
function asd(AnimeName, container, videoURL) {
    ...
    #guydhtvideoCover{position: absolute; top: 0; left: 0; height: 100%; width: 100%; background: black; opacity: 0; z-index: 1 !important;}
    `;
    contentContainer.innerHTML = '<div id="guydhtVideoWrapper"><div id="guydhtvideoCover"></div><video tabIndex="1" id="guydhtVideoMyVideo"></video><div id="guydhtVideoInfo" style="display: none;"><div id="guydhtVideoTimer"></div><span class="guydhtVideoClear"></span><div id="guydhtVideoVolume"></div><span class="guydhtVideoClear"></span></div><div id="guydhtVideoUpperSlider"><div id="guydhtVideoName">' + AnimeName + '</div></div><div id="guydhtVideoSlider"><div id="guydhtPrevEpisodeButton"></div><div id="guydhtVideoPlayPauseButton" class="guydhtVideoPlay"></div><div id="guydhtNextEpisodeButton"></div><div id="guydhtVideoVolumeControl"><svg height="100%" viewBox="0 0 100 100" width="100%"><path></path></svg></div><div id="guydhtVideoVolumeSlider"><div id="guydhtVideoVolumeHandle"></div></div><div id="guydhtVideoAnotherTimerContainer"><div id="guydhtVideoAnotherTimer"></div></div><div id="guydhtVideoFullscreen"><svg height="100%" width="100%"><path d="m 10,16 2,0 0,-4 4,0 0,-2 L 10,10 l 0,6 0,0 z"></path><path d="m 20,10 0,2 4,0 0,4 2,0 L 26,10 l -6,0 0,0 z"></path><path d="m 24,24 -4,0 0,2 L 26,26 l 0,-6 -2,0 0,4 0,0 z"></path><path d="M 12,20 10,20 10,26 l 6,0 0,-2 -4,0 0,-4 0,0 z"></path></svg></div><div id="guydhtVideoSettings"><svg viewbox="0 0 36 36" height="100%" width="35px"><path d="m 23.94,18.78 c .03,-0.25 .05,-0.51 .05,-0.78 0,-0.27 -0.02,-0.52 -0.05,-0.78 l 1.68,-1.32 c .15,-0.12 .19,-0.33 .09,-0.51 l -1.6,-2.76 c -0.09,-0.17 -0.31,-0.24 -0.48,-0.17 l -1.99,.8 c -0.41,-0.32 -0.86,-0.58 -1.35,-0.78 l -0.30,-2.12 c -0.02,-0.19 -0.19,-0.33 -0.39,-0.33 l -3.2,0 c -0.2,0 -0.36,.14 -0.39,.33 l -0.30,2.12 c -0.48,.2 -0.93,.47 -1.35,.78 l -1.99,-0.8 c -0.18,-0.07 -0.39,0 -0.48,.17 l -1.6,2.76 c -0.10,.17 -0.05,.39 .09,.51 l 1.68,1.32 c -0.03,.25 -0.05,.52 -0.05,.78 0,.26 .02,.52 .05,.78 l -1.68,1.32 c -0.15,.12 -0.19,.33 -0.09,.51 l 1.6,2.76 c .09,.17 .31,.24 .48,.17 l 1.99,-0.8 c .41,.32 .86,.58 1.35,.78 l .30,2.12 c .02,.19 .19,.33 .39,.33 l 3.2,0 c .2,0 .36,-0.14 .39,-0.33 l .30,-2.12 c .48,-0.2 .93,-0.47 1.35,-0.78 l 1.99,.8 c .18,.07 .39,0 .48,-0.17 l 1.6,-2.76 c .09,-0.17 .05,-0.39 -0.09,-0.51 l -1.68,-1.32 0,0 z m -5.94,2.01 c -1.54,0 -2.8,-1.25 -2.8,-2.8 0,-1.54 1.25,-2.8 2.8,-2.8 1.54,0 2.8,1.25 2.8,2.8 0,1.54 -1.25,2.8 -2.8,2.8 l 0,0 z" /></svg><div id="guydhtVideoSettingsWindow"><ul id="guydhtVideoSettingsList"><li><div id="guydhtVideoStretch">Stretch Video</div><span id="guydhtVideoStretchVideo"></span></li><li><span id="guydhtVideoRate">1x</span></li><li><div>Auto Play</div><span id="guydhtAutoPlayToggle"></span></li><li><div id="guydhtChooseSubs">Choose Subtitle Track</div></li></ul><ul id="guydhtVideoSettingsList2" style="margin: 0;"><li id="guydhtVideoSettingWindowHead"><div>back</div></li></ul></div></div><div id="guydhtThumbnailContainer"><img></img></div><div id="guydhtVideoTimeTooltip"></div><div id="guydhtVideoWidthLimiter"><div id="guydhtVideoProgressContainer"><div id="guydhtVideoShadowLineForProgress"></div><div id="guydhtVideoProgress"></div><div id="guydhtVideoProgressCircle"></div></div></div></div><div id="guydhtVideoMiddleTooltiper"><div id="guydhtVideoMiddleText"></div></div></div>';
    ...
    function asdf(AnimeName) {
        var video = container.querySelector("#guydhtVideoMyVideo"),
            ...
            cover = container.querySelector("#guydhtvideoCover"),
            autoPlayToggle = container.querySelector("#guydhtAutoPlayToggle"),
            changeRate = container.querySelector("#guydhtVideoRate");
        video.addEventListener("ended", () => cover.style.opacity = 1);
        video.addEventListener("playing", () => cover.style.opacity = 0);
        ...
        changeRate.onclick = () => setSecondScreen([1, 1.25, 1.5, 1.75, 2].map(rate => {
            const rateDisplay = "x" + rate;
            return [rateDisplay, () => {
                video.playbackRate = rate;
                changeRate.innerHTML = rateDisplay;
            }];
        }));
        ...
        autoPlayToggle.parentNode.addEventListener("click", () => {
            autoPlayToggle.checked = localStorage.getItem("autoPlay") !== "true";
            if (autoPlayToggle.checked)
                autoPlayToggle.classList.add("checked");
            else
                autoPlayToggle.classList.remove("checked");
            localStorage.setItem("autoPlay", autoPlayToggle.checked);
        });
        if (localStorage.getItem("autoPlay") === "true")
            autoPlayToggle.classList.add("checked");
        stretch.parentNode.onclick = function () {
            stretch.checked = !stretch.checked;
            if (stretch.checked)
                stretch.classList.add("checked");
            else
                stretch.classList.remove("checked");
            video.style.objectFit = stretch.checked ? "fill" : "";
        };
        settings.tabIndex = 1;
        ...
        settingsWindow.addEventListener("mousedown", e => e.stopPropagation());
        settingsWindow.addEventListener("mouseup", e => e.stopPropagation());
        ...
        function removedPointerLockElement() {
            if (!document.pointerLockElement) {
                showSliders = true;
                return displayMiddleTooltip("unlock");
            }
            showSliders = false;
        ...
        function keydown(e) {
            ...
            var multiplier = 0,
                noCtrlShiftAlt = !e.ctrlKey && !e.shiftKey && !e.altKey;
            if (e.ctrlKey) multiplier += 10;
            if (e.altKey) multiplier += 2.5;
            if (e.shiftKey) multiplier += 0.5;
            multiplier = multiplier !== 0 ? multiplier : 1;
            checkInfoText(true);
            if (e.code === "KeyF" && noCtrlShiftAlt && !e.guydhtSentThis) {
                fullscreen.click();
            } else if (e.code === "Slash" && noCtrlShiftAlt) {
                if (!document.pointerLockElement)
                    wrapper.requestPointerLock();
                else
                    document.exitPointerLock();
            } else if (e.code === "KeyM" && noCtrlShiftAlt) {
                if (!video.muted) muteVideo();
                else unmuteVideo();
            } else if (e.code === "KeyR" && noCtrlShiftAlt) {
            ...
            } else if ((e.key === " " || e.code === "KeyK" || e.code === "KeyP") && noCtrlShiftAlt)
                if (video.paused) video.play();
                else video.pause();
            else if (!isNaN(e.key) && noCtrlShiftAlt) {
                setTimer();
                displaySlider();
                ...
                video.currentTime += -4 * multiplier;
                displayMiddleTooltip(-4 * multiplier);
            } else if (e.code === "KeyS" && noCtrlShiftAlt) {
        ...
        video.addEventListener("guydhtVideoVolumeChange", displaySlider);
        video.addEventListener("volumechange", displaySlider);
        video.addEventListener("guydhtVideoMuteChange", displaySlider);
